...
Данный урок имеет свои особенности, так как в основном связан с рефакторингом кода
и будет проверяться наставниками в ручном режиме. Однако чтобы помочь Вам подготовить Ваш код
для проверки в практически во всех заданиях имеются автотесты, воспользуйтесь ими прежде чем
